...
const Handhurachild = () => {
 ...
 <div className="flex flex-wrap">
  ...
  <p className=" text-xl mb-4 font-bold p-1 pl-10 text-[#4F57A0]  sm:text-5xl mx-auto flex flex-col items-center h-50 md:flex-row writing-mode-vertical-rl"> Handhura Children’s
</p>
